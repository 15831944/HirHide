...
collins2007.txt:9074个最可靠的相互作用
krogan2006_core.txt：Krogan的核心相互作用
krogan2006_extended.txt：Krogan的扩展相互作用
gavin2006_socioaffinities_rescaled.txt：权重来自社会亲和力（socio-affinity）
biogrid_yeast_physical_unweighted.txt：物理的蛋白质相互作用
